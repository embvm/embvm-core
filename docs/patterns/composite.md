...
Driver Registry as a composite pattern of objects?

Composite relates to chain of responsibility, decorator, iterator (traverse composites), visitor (localize operations _ behavior that would be distributed over composites)
Abstract factory
